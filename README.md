...
```sh
npm install git+ssh://git@github.com:stainless-sdks/admesh-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install admesh`
...
1. Via the `ADMESH_LOG` environment variable
...
const client = new Admesh({
  logger: logger.child({ name: 'Admesh' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/admesh-typescript/issues) with questions, bugs, or suggestions.
